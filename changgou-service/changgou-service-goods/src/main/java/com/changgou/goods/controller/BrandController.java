...
public class BrandController {
    ...
    /**
     * 根据点击到的商品分类的ID 查询该分类下的关联到的品牌的列表数据
     * @param id
     * @return
     */
    @GetMapping(value = "/category/{id}")
    public Result<List<Brand>> findByCategoryId(@PathVariable(name="id") Integer id){
        List<Brand> brands =   brandService.findByCategoryId(id);
        return new Result<List<Brand>>(true, StatusCode.OK,"查询某一个商品分类下的品牌列表成功",brands) ;
    }
}
