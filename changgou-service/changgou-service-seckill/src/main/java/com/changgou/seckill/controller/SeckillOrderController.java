...
public class SeckillOrderController {
    ...
    public Result<SeckillStatus> queryStatus() {
        //1.获取当前的登录的用户名
        String username = "szitheima";
        //2.从redis中获取当前用户的订单状态信息
        SeckillStatus seckillStatus = seckillOrderService.getUserSeckillStatus(username);
        seckillStatus.setFrom("2");//秒杀的
        //3.返回
        return new Result<SeckillStatus>(true,StatusCode.OK,"查询的状态成功",seckillStatus);
